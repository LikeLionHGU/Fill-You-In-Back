package com.likelion.fillyouinback.auth.filter;

import com.likelion.fillyouinback.auth.exception.DoNotLoginException;
  ...
  protected void doFilterInternal(
    ...
    UsernamePasswordAuthenticationToken authenticationToken =
        new UsernamePasswordAuthenticationToken(
            loginMember.getId(),
            null,
            List.of(new SimpleGrantedAuthority(loginMember.getAuthority().name())));
